...
parser.add_argument('-l', '--log_filename', type = str, help = "Filename to be used for the logfile e.g. 'nogizaka_blog_downloader_log.txt'; if unspecified, there will be no logfile.")
